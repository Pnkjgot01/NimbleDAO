...
contract('NimbleDao', function(accounts) {
  before("one time init", async() => {
    ...
    kncToken = await TestToken.new("Nimble Network Crystal", "NMB", 18);
    victor = accounts[2];
    loi = accounts[3];
    mike = accounts[4];
  ...
  describe("#Submit Campaign tests", () => {
    ...
    it("Test submit new campaign for next epoch, data changes as expected", async function() {
      ...
      Helper.assertEqual(await kncToken.totalSupply(), data.totalNMBSupply, "total supply is incorrect");
  ...
  describe("#Cancel Campaign tests", () => {
    ...
    it("Test cancel campaign correctly for network fee camp", async function() {
      ...
      Helper.assertEqual(campData.totalNMBSupply, await kncToken.totalSupply(), "camp details should be correct");
  ...
  describe("#Constructor tests", () => {
    it("Test correct data is set after deployment", async function() {
      ...
      Helper.assertEqual(await nimbleDao.kncToken(), kncToken.address, "NMB token is wrong");
