...
async function deployAllContacts(output) {
  ...
  [feeBurnerAddress, feeBurnerContract] = await deployContract(output, "FeeBurner.sol:FeeBurner", [sender,kncTokenAddress,networkAddress, initialNmbToEthRatePrecision]);
